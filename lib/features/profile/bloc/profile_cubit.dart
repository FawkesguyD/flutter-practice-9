...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  Future<void> loadProfile() async {
    try {
      ...
      LoggerService.info(
        'ProfileCubit: Профиль загружен для ${profile.nickname}',
      );
    } catch (e) {
  ...
  Future<void> changeAvatar() async {
    try {
      if (state is ProfileLoaded) {
        ...
        // Используем локальный аватар из assets для всех пользователей
        const newAvatarUrl = 'assets/avatar.png';
